...
QScrollBar::right-arrow {
    image: url(${path}/themes/light/svg/arrow_drop_up__icon-foreground__rotate-90.svg);
}
QScrollBar::down-arrow {
    image: url(${path}/themes/light/svg/arrow_drop_up__icon-foreground__rotate-180.svg);
}
QScrollBar::left-arrow {
    image: url(${path}/themes/light/svg/arrow_drop_up__icon-foreground__rotate-270.svg);
}
QProgressBar {
    border: 1px solid #dadce0;
    border-radius: 4px;
